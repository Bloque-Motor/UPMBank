...
public class UPMBankWSMessageReceiverInOut extends org.apache.axis2.receivers.AbstractInOutMessageReceiver {
        ...
        try {
            ...
            if ((op.getName() != null) &&
                ...
                if ("addBankAcc".equals(methodName)) {
                    es.upm.fi.sos.upmbank.AddBankAccResponse addBankAccResponse40 =
                        null;
                    es.upm.fi.sos.upmbank.AddBankAcc wrappedParam = (es.upm.fi.sos.upmbank.AddBankAcc) fromOM(msgContext.getEnvelope()
                                                                                                                        .getBody()
                                                                                                                        .getFirstElement(),
                            es.upm.fi.sos.upmbank.AddBankAcc.class);

                    addBankAccResponse40 = skel.addBankAcc(wrappedParam);

                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            addBankAccResponse40, false,
                            new javax.xml.namespace.QName(
                                "http://upmbank.sos.fi.upm.es",
                                "addBankAccResponse"));
                } else
                 if ("closeBankAcc".equals(methodName)) {
                    es.upm.fi.sos.upmbank.CloseBankAccResponse closeBankAccResponse42 =
                        null;
                    es.upm.fi.sos.upmbank.CloseBankAcc wrappedParam = (es.upm.fi.sos.upmbank.CloseBankAcc) fromOM(msgContext.getEnvelope()
                                                                                                                            .getBody()
                                                                                                                            .getFirstElement(),
                            es.upm.fi.sos.upmbank.CloseBankAcc.class);

                    closeBankAccResponse42 = skel.closeBankAcc(wrappedParam);

                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            closeBankAccResponse42, false,
                            new javax.xml.namespace.QName(
                                "http://upmbank.sos.fi.upm.es",
                                "closeBankAccResponse"));
                } else
                 if ("removeUser".equals(methodName)) {
                    es.upm.fi.sos.upmbank.RemoveUserResponse removeUserResponse44 =
                        null;
                    es.upm.fi.sos.upmbank.RemoveUser wrappedParam = (es.upm.fi.sos.upmbank.RemoveUser) fromOM(msgContext.getEnvelope()
                                                                                                                        .getBody()
                                                                                                                        .getFirstElement(),
                            es.upm.fi.sos.upmbank.RemoveUser.class);

                    removeUserResponse44 = skel.removeUser(wrappedParam);

                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            removeUserResponse44, false,
                            new javax.xml.namespace.QName(
                                "http://upmbank.sos.fi.upm.es",
                                "removeUserResponse"));
                } else
                 if ("addWithdrawal".equals(methodName)) {
                    es.upm.fi.sos.upmbank.AddWithdrawalResponse addWithdrawalResponse46 =
                        null;
                    es.upm.fi.sos.upmbank.AddWithdrawal wrappedParam = (es.upm.fi.sos.upmbank.AddWithdrawal) fromOM(msgContext.getEnvelope()
                                                                                                                              .getBody()
                                                                                                                              .getFirstElement(),
                            es.upm.fi.sos.upmbank.AddWithdrawal.class);

                    addWithdrawalResponse46 = skel.addWithdrawal(wrappedParam);

                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            addWithdrawalResponse46, false,
                            new javax.xml.namespace.QName(
                                "http://upmbank.sos.fi.upm.es",
                 ...
                 if ("addUser".equals(methodName)) {
                    ...
                    es.upm.fi.sos.upmbank.AddUser wrappedParam = (es.upm.fi.sos.upmbank.AddUser) fromOM(msgContext.getEnvelope()
                                                                                                                  .getBody()
                                                                                                                  .getFirstElement(),
                            es.upm.fi.sos.upmbank.AddUser.class);

                    addUserResponse48 = skel.addUser(wrappedParam);

                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            addUserResponse48, false,
                            new javax.xml.namespace.QName(
                                "http://upmbank.sos.fi.upm.es",
                                "addUserResponse"));
                } else
                 if ("addIncome".equals(methodName)) {
                    ...
                    es.upm.fi.sos.upmbank.AddIncome wrappedParam = (es.upm.fi.sos.upmbank.AddIncome) fromOM(msgContext.getEnvelope()
                                                                                                                      .getBody()
                                                                                                                      .getFirstElement(),
                            es.upm.fi.sos.upmbank.AddIncome.class);

                    addIncomeResponse50 = skel.addIncome(wrappedParam);

                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            addIncomeResponse50, false,
                            new javax.xml.namespace.QName(
                                "http://upmbank.sos.fi.upm.es",
                                "addIncomeResponse"));
                } else
                 if ("login".equals(methodName)) {
                    ...
                    es.upm.fi.sos.upmbank.Login wrappedParam = (es.upm.fi.sos.upmbank.Login) fromOM(msgContext.getEnvelope()
                                                                                                              .getBody()
                                                                                                              .getFirstElement(),
                            es.upm.fi.sos.upmbank.Login.class);

                    loginResponse52 = skel.login(wrappedParam);

                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            loginResponse52, false,
                            new javax.xml.namespace.QName(
                                "http://upmbank.sos.fi.upm.es", "loginResponse"));
                } else
                 if ("getMyMovements".equals(methodName)) {
                    es.upm.fi.sos.upmbank.GetMyMovementsResponse getMyMovementsResponse54 =
                        null;
                    es.upm.fi.sos.upmbank.GetMyMovements wrappedParam = (es.upm.fi.sos.upmbank.GetMyMovements) fromOM(msgContext.getEnvelope()
                                                                                                                                .getBody()
                                                                                                                                .getFirstElement(),
                            es.upm.fi.sos.upmbank.GetMyMovements.class);

                    getMyMovementsResponse54 = skel.getMyMovements(wrappedParam);

                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            getMyMovementsResponse54, false,
                            new javax.xml.namespace.QName(
                                "http://upmbank.sos.fi.upm.es",
                                "getMyMovementsResponse"));
                } else
                 if ("changePassword".equals(methodName)) {
                    es.upm.fi.sos.upmbank.ChangePasswordResponse changePasswordResponse56 =
                        null;
                    es.upm.fi.sos.upmbank.ChangePassword wrappedParam = (es.upm.fi.sos.upmbank.ChangePassword) fromOM(msgContext.getEnvelope()
                                                                                                                                .getBody()
                                                                                                                                .getFirstElement(),
                            es.upm.fi.sos.upmbank.ChangePassword.class);

                    changePasswordResponse56 = skel.changePassword(wrappedParam);

                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            changePasswordResponse56, false,
                            new javax.xml.namespace.QName(
                                "http://upmbank.sos.fi.upm.es",
    ...
    private org.apache.axiom.om.OMElement toOM(
        es.upm.fi.sos.upmbank.AddBankAcc param, boolean optimizeContent)
        throws org.apache.axis2.AxisFault {
        try {
    ...
    private org.apache.axiom.om.OMElement toOM(
        es.upm.fi.sos.upmbank.AddBankAccResponse param, boolean optimizeContent)
        throws org.apache.axis2.AxisFault {
        try {
    ...
    private org.apache.axiom.om.OMElement toOM(
        es.upm.fi.sos.upmbank.CloseBankAcc param, boolean optimizeContent)
        throws org.apache.axis2.AxisFault {
        try {
    ...
    private org.apache.axiom.om.OMElement toOM(
        es.upm.fi.sos.upmbank.CloseBankAccResponse param,
    ...
    private org.apache.axiom.om.OMElement toOM(
        es.upm.fi.sos.upmbank.Logout param, boolean optimizeContent)
        throws org.apache.axis2.AxisFault {
        try {
    ...
    private org.apache.axiom.om.OMElement toOM(
        es.upm.fi.sos.upmbank.RemoveUser param, boolean optimizeContent)
        throws org.apache.axis2.AxisFault {
        try {
    ...
    private org.apache.axiom.om.OMElement toOM(
        es.upm.fi.sos.upmbank.RemoveUserResponse param, boolean optimizeContent)
        throws org.apache.axis2.AxisFault {
        try {
    ...
    private org.apache.axiom.om.OMElement toOM(
        es.upm.fi.sos.upmbank.AddWithdrawal param, boolean optimizeContent)
        throws org.apache.axis2.AxisFault {
        try {
    ...
    private org.apache.axiom.om.OMElement toOM(
        es.upm.fi.sos.upmbank.AddWithdrawalResponse param,
        boolean optimizeContent) throws org.apache.axis2.AxisFault {
        try {
    ...
    private org.apache.axiom.om.OMElement toOM(
        es.upm.fi.sos.upmbank.AddUser param, boolean optimizeContent)
        throws org.apache.axis2.AxisFault {
        try {
    ...
    private org.apache.axiom.om.OMElement toOM(
        es.upm.fi.sos.upmbank.AddUserResponse param, boolean optimizeContent)
        throws org.apache.axis2.AxisFault {
        try {
    ...
    private org.apache.axiom.om.OMElement toOM(
        es.upm.fi.sos.upmbank.AddIncome param, boolean optimizeContent)
        throws org.apache.axis2.AxisFault {
        try {
    ...
    private org.apache.axiom.om.OMElement toOM(
        es.upm.fi.sos.upmbank.AddIncomeResponse param, boolean optimizeContent)
        throws org.apache.axis2.AxisFault {
        try {
    ...
    private org.apache.axiom.om.OMElement toOM(
        es.upm.fi.sos.upmbank.Login param, boolean optimizeContent)
        throws org.apache.axis2.AxisFault {
        try {
    ...
    private org.apache.axiom.om.OMElement toOM(
        es.upm.fi.sos.upmbank.LoginResponse param, boolean optimizeContent)
        throws org.apache.axis2.AxisFault {
        try {
    ...
    private org.apache.axiom.om.OMElement toOM(
        es.upm.fi.sos.upmbank.GetMyMovements param, boolean optimizeContent)
        throws org.apache.axis2.AxisFault {
        try {
    ...
    private org.apache.axiom.om.OMElement toOM(
        es.upm.fi.sos.upmbank.GetMyMovementsResponse param,
        boolean optimizeContent) throws org.apache.axis2.AxisFault {
        try {
    ...
    private org.apache.axiom.om.OMElement toOM(
        es.upm.fi.sos.upmbank.ChangePassword param, boolean optimizeContent)
        throws org.apache.axis2.AxisFault {
        try {
    ...
    private org.apache.axiom.om.OMElement toOM(
        es.upm.fi.sos.upmbank.ChangePasswordResponse param,
        boolean optimizeContent) throws org.apache.axis2.AxisFault {
        try {
    ...
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(
        ...
        es.upm.fi.sos.upmbank.AddBankAccResponse param,
        ...
        try {
            ...
            emptyEnvelope.getBody()
                    ...
                    es.upm.fi.sos.upmbank.AddBankAccResponse.MY_QNAME, factory));
    ...
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(
        ...
        try {
            ...
            emptyEnvelope.getBody()
                         .addChild(param.getOMElement(
                    es.upm.fi.sos.upmbank.CloseBankAccResponse.MY_QNAME, factory));
    ...
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(
        org.apache.axiom.soap.SOAPFactory factory,
        es.upm.fi.sos.upmbank.RemoveUserResponse param,
        boolean optimizeContent, javax.xml.namespace.QName elementQName)
        throws org.apache.axis2.AxisFault {
        try {
            org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
            ...
            emptyEnvelope.getBody()
                         .addChild(param.getOMElement(
                    es.upm.fi.sos.upmbank.RemoveUserResponse.MY_QNAME, factory));
    ...
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(
        ...
        try {
            ...
            emptyEnvelope.getBody()
                         .addChild(param.getOMElement(
                    es.upm.fi.sos.upmbank.AddWithdrawalResponse.MY_QNAME,
                    factory));
    ...
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(
        ...
        try {
            ...
            emptyEnvelope.getBody()
                         .addChild(param.getOMElement(
                    es.upm.fi.sos.upmbank.AddUserResponse.MY_QNAME, factory));
    ...
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(
        ...
        try {
            ...
            emptyEnvelope.getBody()
                         .addChild(param.getOMElement(
                    es.upm.fi.sos.upmbank.AddIncomeResponse.MY_QNAME, factory));
    ...
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(
        ...
        try {
            ...
            emptyEnvelope.getBody()
                         .addChild(param.getOMElement(
                    es.upm.fi.sos.upmbank.LoginResponse.MY_QNAME, factory));
    ...
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(
        ...
        try {
            ...
            emptyEnvelope.getBody()
                         .addChild(param.getOMElement(
                    es.upm.fi.sos.upmbank.GetMyMovementsResponse.MY_QNAME,
                    factory));
    ...
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(
        ...
        try {
            ...
            emptyEnvelope.getBody()
                         .addChild(param.getOMElement(
                    es.upm.fi.sos.upmbank.ChangePasswordResponse.MY_QNAME,
                    factory));

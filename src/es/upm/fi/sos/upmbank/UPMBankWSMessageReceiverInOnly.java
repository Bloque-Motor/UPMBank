 ...
 */
public class UPMBankWSMessageReceiverInOnly extends org.apache.axis2.receivers.AbstractMessageReceiver {
        ...
        try {
            ...
            if ((op.getName() != null) &&
                ...
                if ("logout".equals(methodName)) {
                    //doc style
                    es.upm.fi.sos.upmbank.Logout wrappedParam = (es.upm.fi.sos.upmbank.Logout) fromOM(msgContext.getEnvelope()
                                                                                                                .getBody()
                                                                                                                .getFirstElement(),

...
public class BankAccountResponse implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":BankAccountResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "BankAccountResponse", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static BankAccountResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            BankAccountResponse object = new BankAccountResponse();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"BankAccountResponse".equals(type)) {
                            ...
                            return (BankAccountResponse) es.upm.fi.sos.upmbank.xsd.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }

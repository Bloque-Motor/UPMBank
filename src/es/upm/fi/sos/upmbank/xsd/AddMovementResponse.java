...
public class AddMovementResponse implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":AddMovementResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "AddMovementResponse", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static AddMovementResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            AddMovementResponse object = new AddMovementResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"AddMovementResponse".equals(type)) {
                            ...
                            return (AddMovementResponse) es.upm.fi.sos.upmbank.xsd.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://upmbank.sos.fi.upm.es/xsd", "balance").equals(
                            reader.getName())) {

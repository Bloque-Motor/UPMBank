...
public class Movement implements org.apache.axis2.databinding.ADBBean {
    ...
    public void setQuantity(double param) {
        ...
        localQuantityTracker = !java.lang.Double.isNaN(param);
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":Movement", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "Movement", xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static Movement parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            Movement object = new Movement();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Movement".equals(type)) {
                            ...
                            return (Movement) es.upm.fi.sos.upmbank.xsd.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://upmbank.sos.fi.upm.es/xsd", "IBAN").equals(
                            reader.getName())) {
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://upmbank.sos.fi.upm.es/xsd", "quantity").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                    ...
                    object.setQuantity(org.apache.axis2.databinding.utils.ConverterUtil.convertToDouble(
                            content));
